...
export const dictionary: Translations = {
  ...
  protocolResilienceDesc: { en: 'Building systems that anticipate and neutralize threats.', id: 'Membangunan sistem yang mengantisipasi dan menetralisir ancaman.' },
  ...
  readyDesc: { en: 'Our expertise is your advantage. Open a secure channel to discuss your operational needs.', id: 'Keahlian kami adalah keuntungan Anda. Buka saluran aman untuk mendiskusikan kebutuhan operasional Anda.' },
  ...
  sessionActionDesc: { en: 'Establishing signal handshake...', id: 'Membangunan jabat tangan sinyal...' },
